...
public class Countdown : MonoBehaviour
{
    ...
    // Reference to the lap timer UI.
    [SerializeField] private GameObject lapTimer;

    // Reference to the player's car controls.
    [SerializeField] private GameObject carControls;

    // Background music played once the race begins.
    ...
    IEnumerator CountStart()
    {
        ...
        // Enable the lap timer.
        lapTimer.SetActive(true);

        // Enable player vehicle controls.
